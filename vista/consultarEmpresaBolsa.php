...
<body>
    <div class="container">
        ...
        <div class="right">
            <div class="scroll">
                <div class="top">
                    <h1>Consulta de empresas en la bolsa de trabajo</h1>
                ...
                <!-- TABLA DE CONNSULTAS -->
                <div class="middle">
                    <table class="data" id="tablaEmpresasBolsa">
                        <thead>
                            <tr>
                                <th></th>
                                <th>ID</th>
                        ...
                        <tbody>
                        <?php
                        include_once './modelo/tablaEmpresasBolsa.php';
                        ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="forms">
                    ...
                    <a href="index.php?pages=crearEmpresaBolsa">
                        <button class="new">
                            <label>Insertar empresa en la bolsa de trabajo</label>
    ...
    <script src="./assets/js/busquedas/tablaEmpresaBolsa.js"></script>
