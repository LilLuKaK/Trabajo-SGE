        ...
        <div class="right">
            <div class="scroll">
                ...
                <div class="forms">
                    ...
                    <a href="index.php?pages=crearPractica"><button class="new"><label>Insertar necesidad</label><span class="material-symbols-outlined">switch_access_shortcut_add</span></button></a>
                </div>
            </div>
        </div>
    </div>
