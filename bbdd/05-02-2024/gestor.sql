...
(6, 'Malena', 'Muñoz', 'Lopez', '98745678Z', '123242354', '312312231231', '2024-03-08', 1, 1, '611425518', 'dasdssdadas@fsdfafs.com', 'Los arces', '28922'),
(7, 'Pato', 'Bravo', '', '23423431Z', '312312313', '312321123', NULL, 1, 1, '611425518', 'sdfds@fsdf.com', 'Los arces', '28922'),
(8, 'Gladiolo', 'Bravo', '', '23423431Z', '321321321', '321312312', NULL, 0, 0, '611425518', 'ssdfafsddfds@fsdf.com', 'Los arces', '28922'),
(9, 'Rafa', 'Bravo', '', '23423431Z', '421421442', 'fdsdfagsdfa', NULL, 0, 0, '611425518', 'svdfsavafds@fsdf.com', 'Los arces', '28922'),
(10, 'Elfa', 'Bravo', '', '23423431Z', '123123213', '312312312123', NULL, 1, 1, '611425518', 'svdfsavbfbfzfafds@fsdf.com', 'Los arces', '28922'),
(34, 'Jose Piero', 'Asado', '', '12345678A', '123123546', '123123', '2024-03-03', 1, 1, '123123123', 'Cambiar@gmail.com', 'Calle', '28000');
...
(4, 'Empresa 4', 'D12345678', 'Dueño 4', 'Firmante 4', 'calle 4', 'correo4@gmail.com', '444444444');
...
ALTER TABLE `anyo_necesidad`
  ADD PRIMARY KEY (`ID_Anyo_Necesidad`,`Anyo`) USING BTREE,
  ADD KEY `FK_Anyo_Convenio` (`ID_Convenio`);
...
--
ALTER TABLE `control_empresas`
  MODIFY `ID_Control_Empresa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Filtros para la tabla `anyo_necesidad`
--
ALTER TABLE `anyo_necesidad`
  ADD CONSTRAINT `FK_Anyo_Convenio` FOREIGN KEY (`ID_Convenio`) REFERENCES `control_convenios` (`ID_Convenio`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ciclo_alumno`
  ...
  ADD CONSTRAINT `FK_CA_Ciclo` FOREIGN KEY (`ID_Ciclo_Formativo`) REFERENCES `ciclos_formativos` (`ID_Ciclo_Formativo`) ON DELETE CASCADE ON UPDATE CASCADE;
