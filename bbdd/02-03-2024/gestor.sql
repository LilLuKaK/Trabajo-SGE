...
INSERT INTO `control_convenios` (`ID_Ministerio`, `ID_Control_Empresa`, `ID_Centro_Formativo`, `Fecha_Inicio`, `ID_Convenio`) VALUES
(1234567891, 1, 1, '2024-03-20', 1),
(1234132412, 2, 2, '2024-03-20', 2),
(1234132434, 1, 2, '2024-03-02', 3),
(1234567894, 1, 1, '0000-00-00', 4),
(1234567898, 2, 1, '2024-03-01', 5);
...
ALTER TABLE `convenios_anyo`
  ADD PRIMARY KEY (`ID_Anyo_Necesidad`,`ID_Convenio`),
...
ALTER TABLE `practicas_alumnos`
  ...
  ADD UNIQUE KEY `UN_PraAl_Prac` (`ID_Practica`),
  ADD UNIQUE KEY `UN_PraAl_Al` (`ID_Alumno`),
...
--
ALTER TABLE `anyo_necesidad`
  MODIFY `ID_Anyo_Necesidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `control_convenios`
  MODIFY `ID_Convenio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `vacantes`
  MODIFY `ID_Vacantes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
